...
class MultiEncoder(nj.Module):
    def __init__(
        ...
        **kw,
        ...
        # excluded = ("is_first", "is_last", "vlm", "domain_id")
        excluded = ("is_first", "is_last", "is_terminal", "reward", "cont", "vlm", "domain_id")
...
class MultiDecoder(nj.Module):
    def __init__(
        ...
        **kw,
        ...
        excluded = ("is_first", "is_last", "is_terminal", "reward", "vlm", "domain_id")
